...
//
document.getElementById("picture-1").onclick = function () {
  unhideLightbox("doggo1");
};
document.getElementById("picture-2").onclick = function () {
  unhideLightbox("doggo2");
};
document.getElementById("picture-3").onclick = function () {
